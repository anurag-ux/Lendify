        ...
        <div>
            <div className="card-grid">
                <div className="card">
                    ...
                    <h2>Marketplace</h2>
                    <p>We provide a user-friendly online marketplace where borrowers and lenders can connect
                        and
                ...
                <div className="card">
                    ...
                    <h2>Loan Bidding</h2>
                    <p>Borrowers list their loan requirements on the platform, including the amount, interest rate, and
                ...
                <div className="card">
                    ...
                    <p>Lendify uses smart contracts to automate the loan disbursal and repayment process. This
                ...
                <div className="card">
                    ...
                    <p>The platform provides a simple trackable application process for borrowers to submit their loan applications and for
                ...
                <div className="card">
                    ...
                    <p>Our services use blockchain-based credit scoring algorithms to assess the creditworthiness of
                ...
                <div className="card">
                    ...
                    <p>Lendify provides investment portfolio management tools to help lenders diversify their
